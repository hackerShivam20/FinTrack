...
function CardInfo({budgetList}){
    ...
    // kitne item spent hue hai uske database me se value show karne ke liye below function used
  ...
  return (
    ...
    <div className='p-7 border rounded-lg flex items-center justify-between'>
        ...
        <div className='p-7 border rounded-lg flex items-center justify-between'>
            ...
            <ReceiptText className='bg-primary h-12 w-12 p-3 rounded-full text-white'/>
        </div>
